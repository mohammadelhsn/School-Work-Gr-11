...
space2 = getSpace([item1, str(item1_price), str(item1_quantity), "@", " ", " ", " " f'${round(item1_quantity * item1_price, 2)}'])
...
print(line2)
print(f"{item1.lower()} {item1_quantity} @ {item1_price}" + space2 + f"${round(item1_quantity * item1_price, 2)}")
